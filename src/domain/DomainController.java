...
import persistence.BossesRepository;
import util.Classes;
...
public class DomainController {
    ...
    private final BossesRepository bossRepo;
    ...
    public DomainController() throws ParserConfigurationException, IOException, SAXException {
        ...
        this.bossRepo = new BossesRepository();
    ...
    public BossesRepository getBossRepo() { return bossRepo; }
    
    public BossMonster getBossMonster() {
        return createTemplateBosses();
    }
    ...
    public PlayerCharacter[] createTemplatePlayers() {
        ...
        players[0].addAttack("lightning_bolt");
    ...
    public BossMonster createTemplateBosses() {
        return bossRepo.getBoss("El Ric");
    }
}
